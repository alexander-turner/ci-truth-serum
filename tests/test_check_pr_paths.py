...
code) is asserted in isolation. Workflow discovery is redirected at the module's
dir constants so the real repo's workflows never leak into a case.
"""
...
cpp = load_hook("check_pr_paths.py", "check_pr_paths")
